...
python src/main.py -m atm.e_frac=0.5,1,2 atm.vary_cloud_const=true,false atm.mem=EEEE  comp.sst=5a comp.prwnd=5a
...
python src/main.py -m atm.e_frac=0.5,1,2 atm.vary_cloud_const=true,false coup.stress_trend=false coup.add_stress=false atm.prcp_land=1,0 ocean.flux_once=false atm.mem=EEEE  comp.sst=5a comp.prwnd=5a animate=true oc.f1prime=-0.006
